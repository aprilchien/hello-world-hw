...
turtle.speed(50)                              #sets the drawing speed
...
def cloud(radius, cloud_color="white"):
    ...
    for i in range(8):                        #repeat function 8 times
        ...
        if (i%2 == 1):                        #% returns the remainder of i/2, checks if num odd
            turtle.right(90)                  #moves "forward"(down) a randomly generated amount
            turtle.forward(randomNum)         #rotates left 90 degrees (resetting it)
            turtle.left(90)
